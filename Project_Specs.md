...
# Listar facultades - Especificaciones - HU 6
...
- Contenido (seg�n scope):
  - Campus: hoja/secci�n resumen, hoja campus, hoja por facultad, hoja de bloques agrupados por facultad; incluye KPIs (facultades/bloques/ambientes activos/inactivos, tipos, capacidad total/examen, activos asociados) y tablas por nivel.
