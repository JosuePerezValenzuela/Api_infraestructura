...
// DTO para validar el cuerpo del upsert por NIA.
// Los campos son opcionales porque al actualizar solo se envian los que cambian.
export class UpsertActivoDto {
  @ApiPropertyOptional({
    description: 'Nombre del activo (requerido si el activo no existe)',
    maxLength: 32,
